      ...
      <div className="w-50 bg-[#C40000]/[.06] h-[804px] mt-[100px] flex  ">
        <div className="w-6/12 h-[804px] flex flex-col ml-[50px] mr-[80px] ">
          ...
          <p>
            ...
            company's visibility on social media platforms. Social algorithms
            have made it more difficult to reach and engage consumers in their
            news feeds organically. However, with paid advertisements, such as
            the examples above, you can immediately increase awareness about the
            product and your brand. <br />
            <br />
            Below, we'll go through D2C social advertising in detail, look at
            some examples, and provide an overall view of how our plans can help
            your brand grow. With over 25 years of experience, we've helped D2C
            brands like yours achieve impressive results through social media
            ...
            source. To speak with a Digital Marketing Specialist about our
            marketing services, please call us.{" "}
          </p>
        </div>
