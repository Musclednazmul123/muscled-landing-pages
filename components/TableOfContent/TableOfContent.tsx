  ...
  return (
    <>
      ...
      <div className="border-[1px] border-solid border-black border-opacity-[30%] rounded-[10px] w-[440px]">
        <div
          className="bg-[#F2F2F2] text-white py-2 px-8 flex 
        ...
        >
          ...
          <div onClick={toggle} className="cursor-pointer">
            <ChevronDownIcon
              className={`w-9 h-9 transition-transform text-black-80 ${
        ...
        <ul
          className={`bg-inherit  pl-4 py-2 rounded-[10px] rounded-bl-[10px] rounded-br-[10px] ${
        ...
        >
          {isOpen &&
            list.map((e, index) => {
              return (
                <li
                  className="flex items-center text-black-100 font-light py-2 gap-2"
                  key={index}
                >
                  <div>
