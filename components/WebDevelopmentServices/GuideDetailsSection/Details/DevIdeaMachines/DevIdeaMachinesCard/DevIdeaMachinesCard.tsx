    ...
    <div className='flex w-[638px] h-[568px] bg-[#6E0000] rounded-lg justify-evenly pl-2 relative z-50 items-center'>
        <div className='flex flex-col text-white w-[294px] space-y-8 justify-center'>
          ...
          <div className='w-[288px]'>
            <p className='font-bold text-3xl leading-[45px]'>Measuring the 
                metrics that affect
                your bottom line.
            </p>
          </div>
          ...
          <div className='grid grid-cols-2 grid-rows-2 gap-y-6 '>
            {
               measures.map((measure:string):JSX.Element=>{
          ...
          <button className='bg-white text-base flex rounded-lg justify-center max-w-[172px]  
          min-h-[56px] text-[#8E0000] font-[500] items-center '>
               Learn More 
              <div className='ml-2 mt-2'><Image src="/devIdeaMachinesArrow.png" width="24" height="24"/></div>
          </button>
