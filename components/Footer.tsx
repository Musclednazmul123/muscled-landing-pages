  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-full lg:w-4/12 bg-red-800 pt-24 pl-4 pr-24 text-right pb-12 mx-auto container">
          ...
          <div className="flex flex-wrap justify-center items-center gap-10 xl:gap-32">
            ...
            <div className="flex text-white gap-10 items-center">
              <div className="flex flex-col font-semibold">
                <h4 className="text-xl text-white text-right">1.6 million</h4>
