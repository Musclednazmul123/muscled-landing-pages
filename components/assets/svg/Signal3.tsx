...
const Signal3: FC<SVGProps> = ({ className, opacity }) => {
    return (
        <svg
        ...
        >
            <g filter="url(#filter0_d_4_25739)">
            ...
            <defs>
                ...
                >
                    ...
                    <feMorphology
                        ...
                        operator="dilate"
                        in="SourceAlpha"
                        result="effect1_dropShadow_4_25739"
                    />
                    <feOffset />
                    ...
                    <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_4_25739"
                        result="shape"
                    />
                </filter>
            </defs>
