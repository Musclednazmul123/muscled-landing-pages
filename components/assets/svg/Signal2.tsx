...
const Signal2: FC<SVGProps> = ({ className, opacity }) => {
    return (
        <svg
        ...
        >
            <g filter="url(#filter0_d_4_25705)">
            ...
            <defs>
                ...
                >
                    ...
                    <feMorphology
                        ...
                        operator="dilate"
                        in="SourceAlpha"
                        result="effect1_dropShadow_4_25705"
                    />
                    <feOffset />
                    ...
                    <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_4_25705"
                        result="shape"
                    />
                </filter>
            </defs>
