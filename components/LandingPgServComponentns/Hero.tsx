      ...
      <Section className="py-24 flex flex-wrap h-auto mx-auto justify-center items-center space-y-24 lg:space-y-0 gap-x-[57px] lg:justify-between">
        <div className="max-w-[640px]">
          ...
          <p className="hero-description text-2xl md:text-2xl leading-[36px] my-7">
            {/* {description} */}
            Landing pages play a crucial role in the marketing and advertising
            of your business. At <span className="highlight">Muscled</span> we
            can provide you with a professionally designed landing page that
            will have a greater impact in your sales, boost your lead quality
