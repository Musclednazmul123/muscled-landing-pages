    ...
    <>
      ...
      <div className="mt-[120px]">
        ...
        <p className="md:text-xl text-base leading-loose text-black text-opacity-70 mt-10">
          ...
          <ul className="list-disc pl-8">
            <li>
              <span className="font-bold">Deep Dive:</span> As your partner, we
              will ask you questions about your brand, your target customers,
              and your future goals. We want to make it happen. That’s why your
              customized approach will be tailored to your business and
