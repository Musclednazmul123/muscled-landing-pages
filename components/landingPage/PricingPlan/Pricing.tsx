...
export default function Pricing() {
	return (
		<div className="bg-white w-full pt-[50px]">
			<div className="py-16 bg-[#F9F9F9]  mx-auto conatiner lg:px-0 md:px-12 px-4">
				<h2 className="md:text-4xl text-2xl font-bold leading-[130%] text-center">
					Ecommerce PPC Management Services
				</h2>
				<div className="container mx-auto justify-items-center grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 mt-[60px] gap-5">
					<div className="bg-white max-w-[400px] border rounded-lg border-black border-opacity-70">
						<div className="inline-flex flex-col space-y-[70px] items-center justify-between py-10 bg-red-700 bg-opacity-5 rounded-bl-lg rounded-br-lg w-full">
