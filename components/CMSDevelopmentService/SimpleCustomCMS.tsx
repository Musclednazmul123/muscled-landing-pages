          ...
          <div className="mt-7">
            <ul className=" font-sans text-md xl:text-xl list-inside list-disc">
              <li className="mt-1 md:pb-0">
                <span className="-ml-2">
                  CMS pricing packages that are customized to help you get
                  started on a project while staying within your budget.
                </span>
              </li>
              <li className="mt-1 md:pb-0">
                <span className="-ml-2">
                  Web integration of various CMS platforms, such as
                  transactional, e-commerce, and content-based CMS.
                </span>
              </li>
              <li className="mt-1 md:pb-0">
                <span className="-ml-2">
