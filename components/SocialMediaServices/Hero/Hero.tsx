      ...
      <div className='xl:py-[100px] md:py-20 py-4  px-5 md:px-10 lg:px-20 xl:px-4 mx-auto container  xl:flex items-center justify-between'>
        <div className='max-w-[720px]'>
          ...
          <h1 className='lg:text-6xl md:text-5xl text-2xl xl:text-left text-center font-bold lg:leading-[72.8px] text-white mt-[30px]'>
            ...
            <br />
            <span className='whitespace-nowrap'>Social Media Marketing</span>
          </h1>
          <p className='md:text-xl text-lg  xl:text-left text-center lg:leading-[30px] text-white mt-5'>
            Increase your return on investment (ROI) from social media platforms
            like Instagram, Facebook, and LinkedIn with services from Muscled.
            Our competitive social media management services give your business
            a head start in growing its brand awareness and revenue from social
            media.{' '}
          </p>
