...
const ImportantLinksItem: FC<ImportantLinkItemDataProps> = ({
  heading,
  listItems,
  bgColor,
  className,
  ...
  return (
    <div
      className={`flex flex-col w-[400px] gap-y-[40px] ${
        bgColor ? bgColor : "bg-[#C40000]"
      } p-[30px] ${className}`}
    >
      <div>
      ...
      {listItems.map((item, index) => {
        return (
          <div className="flex flex-col gap-y-[30px]" key={index}>
