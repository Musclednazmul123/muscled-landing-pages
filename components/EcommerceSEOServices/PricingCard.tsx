    ...
    <div className="border border-[rgba(0,0,0,0.7)] flex flex-col w-full rounded-[10px] overflow-hidden">
      <div className={`py-10 px-4 ${headerClassName}`}>
        ...
        <div className="flex justify-center">
          <p className="text-[20px] text-[#00000080] text-center leading-[32.5px] mt-[10px]">
            {subtitle}
          </p>
        </div>
      </div>
      ...
      <div className="py-[40px] px-[30px] bg-white">
        ...
        <div className="flex justify-center">
          <button className="rounded-[5px] px-10 py-[15px] bg-black font-semibold text-[20px] leading-[30px] text-white">
            Customize My Plan
          </button>
        </div>
      </div>
