...
const projectCards = [
  {
    image: (
      <img
        className="mx-auto w-[174px] h-[174px]"
    ...
    name: "Project Name",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nec tellus felis ut amet eget. Et turpis a netus enim, et.",
  },
  {
    image: (
      <img
    ...
    <div className="bg-[#F8FAA5] pt-[65px] pb-[159px]">
      <div className="pl-[158px] pr-[65px]">
        <div className="flex flex-wrap justify-between">
          <div className="max-w-[822px] mt-[120px] text-center">
            <h1 className="red-stroke text-[#F8FAA5] text-[85px] tracking-[0.215em]">
              INITIATIVES OF MUSCLED
            </h1>
            <p className="m-auto text-center text-[24px] max-w-[546px] mt-[39px]">
              Muscled is committed to leaving the world a better place than we
              found it. That's why we've partnered with organizations like
              Pencils of Promise, The Water Project, Empower Playgrounds, The
              Ocean Cleanup, and others all over the world!
            </p>
          </div>
        ...
        <div className="flex flex-wrap justify-between mt-[32px]">
          <img
            className="w-[518px] h-[345px] mt-[112px]"
            src={image2.src}
            alt="image"
          />
      ...
      <div className="mt-[316px]">
        <div className="text-right mr-[200px] mb-[69px] flex justify-end">
          <button
            type="button"
            className="h-[82px] w-[82px] shadow-md bg-white rounded-full flex justify-center items-center"
          ...
          <button
            type="button"
            className="h-[82px] w-[82px] shadow-md bg-white rounded-full ml-[69px] flex justify-center items-center"
