...
import {
  Props,
  returnServerSiderProps,
  ServerProps,
  heroSectionProps,
  partnersSectionProps,
} from "../../components/WebDevelopmentServices/WebDevInterfaces/WebDevInterfaces";
import { testimonialsSectionProps } from "../../components/WebDevelopmentServices/WebDevInterfaces/WebDevInterfaces";

export async function getServerSideProps(
  context: ServerProps
): Promise<returnServerSiderProps> {
...
let heroSectionData: heroSectionProps = {
  heroData: {
    ...
    headingWidth: "720",
    paragraph:
      "PHP. ASP. HTML5. No matter what language your website, application, or custom development project speaks — or needs to speak — we can help. WebFX’s skilled team of developers can deliver a highly customized and fully integrated web development solution at a competitive cost.",
  },
...
let testimonialsSectionData: testimonialsSectionProps = {
  ...
  testimonialData: {
    details:
      "“Muscled has gone above and beyond to make me happy. So far, after a few months, I have already seen significant improvement in rankings and conversions, and they have also greatly improved the speed of my site.”",
    owner: "Owner",
